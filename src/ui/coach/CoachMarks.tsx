...
const STEPS: (TutorialStep & { meta: TabName })[] = [
  ...
  },
  {
    ...
    title: '촬영 준비',
    /*
      2026-08-31 지시 — 선반이 **언제 뜨는지**부터 알려 줍니다. 홈은 2초쯤 가만히
      보고 있어야 선반이 나오는데, 그걸 모르면 이 버튼을 다시 찾지 못합니다.
      ("홈 화면에서" 는 뺐습니다 — 이 안내가 이미 홈에서 뜨고 있습니다)
    */
    description:
      '2초정도 대기하면 해당 숏폼의 촬영 가이드를 보고 따라할 수 있는 버튼이 떠요. 이어서 AI가 자동으로 편집해줘요.',
    /*
      🔴 **다시 원형입니다** (2026-08-31 지시: "포커싱 모양이 지금 사각형인데
         이전과 같이 원형으로"). 짚는 것이 40×40 **동그란 버튼**이라 원이 맞습니다.
         한때 네모로 바꿨던 건 구멍이 엉뚱한 데 뚫리던 때의 오진이었습니다 —
         진짜 원인은 **선반이 화면에 없던 것**이었습니다.
    */
    pad: 6,
    radius: 999,
  },

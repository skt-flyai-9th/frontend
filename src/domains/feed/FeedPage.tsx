...
const styles = StyleSheet.create({
  /*
    🔴 **바탕색을 위아래와 양옆에 다르게 씁니다** (2026-08-31, "양옆 테두리가 안 사라진다").

    이음매가 생길 수 있는 자리가 둘이고, **닿는 것이 서로 다릅니다.**

      양옆  영상의 왼쪽·오른쪽. 닿는 건 **영상 자체**입니다.
            → 무대 바탕을 **검정**으로. 반 픽셀이 남아도 영상 가장자리에 묻힙니다.
      위아래 영상과 바 사이. 닿는 건 **흰 바**(앱바·선반·탭바·홈 인디케이터)입니다.
            → 장 바탕을 **흰색**으로. 남아도 바에 묻힙니다.

    ⚠️ 한동안 **둘 다 흰색**으로 뒀는데, 그러면 양옆 이음매가 영상 옆에서
       **밝은 줄**로 도드라집니다. 실제 안드로이드 폭은 392.72 · 411.43 같은 소수라
       레이아웃이 물리 픽셀로 내려가며 반 픽셀이 어긋날 수 있습니다.
       **웹에서는 화면 폭이 정수라 이게 절대 재현되지 않습니다** — CDP 가 정수만
       받습니다. 그래서 "틈 0" 이라고 재고도 폰에서는 줄이 보였습니다.

    무대 높이·폭은 이미 영상과 **같은 식**으로 맞춰 뒀습니다(`videoHeightFor`).
    이건 그 위에 얹는 **두 번째 안전장치**입니다.
  */

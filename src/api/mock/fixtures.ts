  ...
  platforms: [
    ...
    },
    {
      /*
        ...
        곡선은 `그래프예시.png` 의 주간 조회수 추이를 **그대로** 옮겼습니다 —
        예시 그림에서 일곱 점의 높이를 재어 같은 순서·같은 굴곡이 나오게 잡았습니다.
          월 낮게 → 화 봉우리 → 수 골 → 목 상승 → 금 더 → 토 꼭대기 → 일 하강
          월 64 · 화 205 · 수 109 · 목 259 · 금 361 · 토 421 · 일 307 = 1726
          크기 순서  월 < 수 < 화 < 목 < 일 < 금 < 토   (예시와 동일)

        ⚠️ 예시가 **일요일에 떨어지는** 모양이라 전날 대비는 마이너스입니다.
           일 307 ÷ 토 421 = −27.08% → −27%   (사장님이 알고 지시하신 값입니다)
        좋아요 증감  18 ÷ 17 = +5.88% → +6%
      */
      platform: 'INSTAGRAM',
      weekly_views: 1726,
      weekly_likes: 18,
      views_change_rate: -27,
      likes_change_rate: 6,
      daily_views: [
        { date: '2026-08-24', views: 64 },
        { date: '2026-08-25', views: 205 },
        { date: '2026-08-26', views: 109 },
        { date: '2026-08-27', views: 259 },
        { date: '2026-08-28', views: 361 },
        { date: '2026-08-29', views: 421 },
        { date: '2026-08-30', views: 307 },
      ],
    },
  ],
};

...
- 설정 목록에 시안 5번째 "상태·오류 화면 (리뷰용)" 은 없습니다 — 26_states 라 구현 대상이
  아니고, 그 자리를 다른 항목으로 메우지 않았습니다.
  **2026-08-30 에 "앱 사용법 다시 보기" 를 넣었습니다** — 시안을 메운 게 아니라 사장님이
  지시한 새 항목입니다(튜토리얼을 다시 보려면 판 번호를 올려야 했음). 지우지 마세요.
